...
SECRET_KEY = '#*yphYavbYFwP#tntbcTSTMPwKnFNtJYg!2w&Q#w#mCoBx#AmVqQnNdn66UwrZwK'
...
ROOT_URLCONF = 'as207960_feedback.urls'
...
WSGI_APPLICATION = 'as207960_feedback.wsgi.application'
...
STATIC_URL = '/static/'
EXTERNAL_URL_BASE = "http://localhost:8004"

CRISPY_TEMPLATE_PACK = "bootstrap4"
CRISPY_FAIL_SILENTLY = not DEBUG

EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"
DEFAULT_FROM_EMAIL = "Glauca Feedback <feedback@aglauca.digital>"

with open(os.path.join(BASE_DIR, "secrets/keycloak.json")) as f:
    keycloak_conf = json.load(f)

with open(os.path.join(BASE_DIR, "secrets/gchat.json")) as f:
    gchat_conf = json.load(f)
...
GCHAT_WEBHOOK_URL = gchat_conf["url"]
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'feedback.api.auth.BearerAuthentication',
        'feedback.api.auth.SessionAuthentication',
    ],
